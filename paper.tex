...
\begin{figure}[htbp] \centering
  ...
  \label{fig:diff}
\end{figure}
% Morning more: Southwest Brooklyn, North Queens, Bronx, North Manhattan
% Night more: Northern Brooklyn (Williamsburg)
...
\begin{tabular}{rrrrrrrrrrr}
  \toprule
   & \multicolumn{5}{c}{City} & \multicolumn{2}{c}{Airport} & \multicolumn{3}{c}{Boroughs} \\
